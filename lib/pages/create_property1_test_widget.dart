...
class CreateProperty1TestWidget extends StatefulWidget {
  const CreateProperty1TestWidget({
    Key? key,
    this.owner,
  }) : super(key: key);
  ...
  @override
  _CreateProperty1TestWidgetState createState() =>
      _CreateProperty1TestWidgetState();
}

class _CreateProperty1TestWidgetState extends State<CreateProperty1TestWidget> {
  late CreateProperty1TestModel _model;
                      ...
                      Padding(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            ...
                            content: Text('Are you sure you want to add a property?'),
                            actions: [
                              TextButton(
                                onPressed: () =>
