      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateProperty2Widget(
            ...
            neighbourhood: params.getParam('neighbourhood', ParamType.String),
            address: params.getParam('address', ParamType.String),
            owner: params.getParam(
                'owner', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'createProperty_1Test',
          path: '/createProperty1Test',
          builder: (context, params) => CreateProperty1TestWidget(
            owner: params.getParam(
                'owner', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'createProperty_0',
          path: '/createProperty0',
          asyncParams: {
            'owner': getDoc(['users'], UsersRecord.serializer),
          },
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'createProperty_0')
              : CreateProperty0Widget(
