...
class AppStateNotifier extends ChangeNotifier {
  Glen3FirebaseUser? initialUser;
  Glen3FirebaseUser? user;
  ...
  void update(Glen3FirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'editProperty2',
              asyncParams: {
                'propertyRef': getDoc(['Listing'], ListingRecord.serializer),
              },
            ...
            FFRoute(
              ...
              asyncParams: {
                'propertyRef': getDoc(['Listing'], ListingRecord.serializer),
                'propertyRef2': getDoc(['Listing'], ListingRecord.serializer),
              },
              builder: (context, params) => EditProperty1Widget(
                propertyRef: params.getParam('propertyRef', ParamType.Document),
                propertyRef2:
                    params.getParam('propertyRef2', ParamType.Document),
              ),
            )
